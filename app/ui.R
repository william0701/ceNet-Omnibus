...
analysis_tab=tabItem(tabName = "analysis",
                     ...
                     div(class="box box-solid box-primary",
                         ...
                         div(class='box-body',
                             ...
                             div(class='row',
                                 div(class='col-lg-3',
                                     ...
                                     conditionalPanel( "input.enrichment_choose_module_or_customize_gene=='Custom_input'",
                                                       textAreaInput("enrichment_Custom_input1", "Custom input", "gene", width = "400px",height = "200px")
                                     )
                                )
                             ),
                             ...
                             pickerInput(inputId = 'enrichment_Data_Sources',label = 'Data Sources',
                                         choices = c("GO molecular function"="GO_molecular_function",
                     ...
                     tabsetPanel(type="pills",
                                 tabPanel(title="Network Topology Properties",
                                          h2("Part1: Network Topology Properties",style='font-family:Georgia'),
                                          div(class="box box-solid box-primary",
                                              div(class="box-header",
                                                  h3(class="box-title"),
                                ...
                                tabPanel(title="Network Modules",
                                         h2("Part2: Network Modules",style='font-family:Georgia'),
                                         div(class="box box-solid box-primary",
                                             div(class='box-header',
                                                 h3(class="box-title"),
